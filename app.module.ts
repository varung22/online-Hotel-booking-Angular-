...
@NgModule({
  ...
  imports: [
    BrowserModule, RouterModule.forRoot(routes), AppRoutingModule, FormsModule, HttpClientModule,
    MatDatepickerModule, MatNativeDateModule, MatInputModule, BrowserAnimationsModule, ReactiveFormsModule, MatDialogModule
  ],
  providers: [ HotelService, RatingPipe, PagerService, UserServiceService],
